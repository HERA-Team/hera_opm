...
if is_lin_pol $fn; then
    ...
    echo omni_abscal_run.py --refant ${refant} --bl_cut ${bl_cut} --edge_cut ${edge_cut} --avg_dly_slope_cal --delay_slope_cal --phase_slope_cal --TT_phs_cal --abs_amp_cal --phs_max_iter ${phs_max_iter} --phs_conv_crit ${phs_conv_crit} --overwrite --calfits_infile ${omni_fn} --output_calfits_fname ${calfits_fn} --data_file ${omni_data} --model_files ${model_files} 
    omni_abscal_run.py --refant ${refant} --bl_cut ${bl_cut} --edge_cut ${edge_cut} --avg_dly_slope_cal --delay_slope_cal --phase_slope_cal --TT_phs_cal --abs_amp_cal --phs_max_iter ${phs_max_iter} --phs_conv_crit ${phs_conv_crit} --overwrite --calfits_infile ${omni_fn} --output_calfits_fname ${calfits_fn} --data_file ${omni_data} --model_files ${model_files} 
fi
...
#
# We accomplish this by passing in the *.abs.calfits to the first polarization thread
...
if is_same_pol $bn $pol1; then
    ...
    # get the name of the abs.calfits file
    nopol_base=$(remove_pol $bn)
    omni_f=`echo ${nopol_base}HH.uv.abs.calfits`

    # run the xrfi command
    echo delay_xrfi_run.py --infile_format=miriad --algorithm=xrfi --kt_size=${KT_SIZE} --kf_size=${KF_SIZE} --sig_init=${SIG_INIT} --sig_adj=${SIG_ADJ} --calfits_file=${omni_f} --extension=.flags.npz --summary ${bn}HH.uvO
    delay_xrfi_run.py --infile_format=miriad --algorithm=xrfi --kt_size=${KT_SIZE} --kf_size=${KF_SIZE} --sig_init=${SIG_INIT} --sig_adj=${SIG_ADJ} --calfits_file=${omni_f} --extension=.flags.npz --summary ${bn}HH.uvO
    ...
    # run the xrfi command
    echo delay_xrfi_run.py --infile_format=miriad --algorithm=xrfi --kt_size=${KT_SIZE} --kf_size=${KF_SIZE} --sig_init=${SIG_INIT} --sig_adj=${SIG_ADJ} --model_file=${vis_f} --model_file_format=uvfits --extension=.flags.npz --summary ${bn}HH.uvO
    delay_xrfi_run.py --infile_format=miriad --algorithm=xrfi --kt_size=${KT_SIZE} --kf_size=${KF_SIZE} --sig_init=${SIG_INIT} --sig_adj=${SIG_ADJ} --model_file=${vis_f} --model_file_format=uvfits --extension=.flags.npz --summary ${bn}HH.uvO
else
    # These threads run just on raw visibility
    echo delay_xrfi_run.py --infile_format=miriad --algorithm=xrfi --kt_size=${KT_SIZE} --kf_size=${KF_SIZE} --sig_init=${SIG_INIT} --sig_adj=${SIG_ADJ} --extension=.flags.npz --summary ${bn}HH.uvO
    delay_xrfi_run.py --infile_format=miriad --algorithm=xrfi --kt_size=${KT_SIZE} --kf_size=${KF_SIZE} --sig_init=${SIG_INIT} --sig_adj=${SIG_ADJ} --extension=.flags.npz --summary ${bn}HH.uvO
fi

...
# 10 - iter0_prefix: if not "", save omnical results after the 0th interation with this prefix iff there will be a rerun
# 11 - ant_metrics_extension: file extension to replace .uvh5 with to get ant_metrics files
# 12 - good_statuses: string list of comma-separated (no spaces) antenna statuses considered good enough to try calibrating
